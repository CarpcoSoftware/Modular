...
CREATE TABLE `user` (
  ...
  KEY `identifier_idx` (`idRole`),
  KEY `identifier_idx1` (`idCompany`),
  CONSTRAINT `fk_role_user` FOREIGN KEY (`idRole`) REFERENCES `role` (`identifier`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_company_user` FOREIGN KEY (`idCompany`) REFERENCES `company` (`identifier`) ON DELETE NO ACTION ON UPDATE NO ACTION
