...
public abstract class AbstractCompanyModel extends DefaultTableModel {
   ...
   */
  public AbstractCompanyModel(int identifier, String code, String name, DateTime dtCreation,
  ...
  public String toString() {
    return "AbstractCompanyModel [companyAddressSet=" + companyAddressSet + ", identification="
