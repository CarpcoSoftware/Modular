...
public class Invoice extends DefaultTableModel {
  ...
  public String toString() {
    return "Invoice [company=" + company + ", user=" + user + ", dtInvCreation=" + dtInvCreation
        + ", dtInvExpiration=" + dtInvExpiration + ", objectType=" + objectType + ", objectStatus="
        + objectStatus + ", invoiceItemSet=" + invoiceItemSet + ", identification=" + identifier
  ...
  public int hashCode() {
    ...
    result = prime * result + ((dtInvCreation == null) ? 0 : dtInvCreation.hashCode());
    result = prime * result + ((dtInvExpiration == null) ? 0 : dtInvExpiration.hashCode());
    result = prime * result + ((invoiceItemSet == null) ? 0 : invoiceItemSet.hashCode());
