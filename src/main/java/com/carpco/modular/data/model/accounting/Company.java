 ...
 * 
 * It will contains all companies (Natural and legal firms) the type associated to this will help to
 * identify it.
 * 
...
public class Company extends AbstractCompanyModel {
  ...
  public String toString() {
    return "Company [objectType=" + objectType + ", objectStatus=" + objectStatus
