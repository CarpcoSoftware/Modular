...
public class Product extends DefaultTableModel {
  ...
  public String toString() {
    return "Product [objectType=" + objectType + ", objectStatus=" + objectStatus
        + ", productCategory=" + productCategory + ", vlMinPrice=" + vlMinPrice + ", vlMaxPrice="
        + vlMaxPrice + ", identification=" + identifier + ", code=" + code + ", name=" + name
  ...
  public boolean equals(Object obj) {
    ...
    if (productCategory == null) {
      ...
      return false;
    if (Double.doubleToLongBits(vlMaxPrice) != Double.doubleToLongBits(other.vlMaxPrice))
      return false;
    if (Double.doubleToLongBits(vlMinPrice) != Double.doubleToLongBits(other.vlMinPrice))
      return false;
    return true;
  }
