...
public class InvoiceItem extends DefaultTableModel {
  ...
  public String toString() {
    return "InvoiceItem [product=" + product + ", vlPriceUnity=" + vlPriceUnity + ", vlQuantity="
        + vlQuantity + ", taxPercent=" + taxPercent + ", identification=" + identifier + ", code="
  ...
  public boolean equals(Object obj) {
    ...
    if (product == null) {
      ...
      return false;
    if (Double.doubleToLongBits(taxPercent) != Double.doubleToLongBits(other.taxPercent))
      return false;
    if (Double.doubleToLongBits(vlPriceUnity) != Double.doubleToLongBits(other.vlPriceUnity))
      return false;
